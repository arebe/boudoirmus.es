...
# What is the name of this app?
	define('APP_NAME', 'Boudoir Muses');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'hearus@boudoirmus.es'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'boudoirmuses@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', 'boudoirm_boudoirmus_es'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'klk2j489cjamalal02907ijoekjlja09cv08auvdjvakdj;slj92835y');
	define('TOKEN_SALT', 'lkjg00j3;q;;s90dk3mcj0wa85-238jfakf;va-92834nclkmaosiduf90');